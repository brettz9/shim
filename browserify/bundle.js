var self = typeof global === 'undefined' ? window : global; // One currently has to add this line manually each time!
...
(function(global){/*globals define*/
global.Array.prototype.map = function map (callback, thisArg) {
    'use strict';
